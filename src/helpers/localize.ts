...
const de: Record<string, string> = {
  ...
  "action.confirm_cancel": "Abbrechen bestätigen", "action.dismiss": "Schließen",
  ...
  "editor.name": "Name überschreiben", "editor.icon": "Icon überschreiben", "editor.accent_color": "Akzentfarbe", "editor.detect": "Geräte-Entities erkennen",
